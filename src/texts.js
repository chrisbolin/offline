...
export const languages = {
  ...
  fa: {
    ...
    rightToLeft: true,
    onlineElements: () => [
      <h1>براي مشاهده این صفحه باید آفلاین بشید.</h1>,
      <br />,
      <h2>
        {MOBILE
    ...
    bodyParagraphs: () => [
      <p>
        <i>2017. مطالعه این متن فقط چند دقیقه طول می کشه.</i>
      </p>,
      <p>
        آیا تمایل دارید بازده بیشتري داشته باشید؟ کافیه که آفلاین بشید، چرا که
        وصل بودن دائمی به اینترنت به معنی حفظ اتصال به منبع حواس پرتی هست، چه
        حواس پرتی هاي درونی چه بیرونی.
      </p>,
      <p>
        عوامل حواس پرتی بیرونی متعدد و شناخته شده هستند؛ شما یک پیام جدید در
        جیمیل، اسلک، توییتر، فیسبوك، اینستاگرام، اسنپ چت، لینکدین یا تلگرام
        دارید. دوستان، خانواده، همکاران شما و اسپمر ها همه و همه دسترسی مستقیم
        به توجه گران بهاي شما دارند.
      </p>,
      <p>
        ولی این حواس پرتی هاي درونی هستن که واقعاً مهلک هستن و صدمه می زنن. شما
        می تونید اعلان هاي توییتر و تلگرام رو خاموش کنید و از نرم افزار اسلک
        خارج بشید ولی چطور از پریشان فکري ها جلوگیري می کنید وقتی ذهن خودتون،
        شما رو از خط خارج می کنه؟
      </p>,
      <p>
        ن ساعت ها، مثل گیر کردن در تارهاي عنکبوت، در کنجکاوي هاي خودم گیر کردم.
        خطرناك ترین اونا وسوسه هاي لحظه اي هستن مثل این که کنجکاو میشم بدونم
        دومین زبان رایجی که در دنیا صحبت می شه چیه؟ اون 500 میلی ثانیه ها می
        تونن روز شما رو تغییر بدن چون هیچ وقت فقط یه جستجوي گوگل یا خوندن یه
        مقاله ویکیپدیا نیست.
      </p>,
      <p>
        قطع شدن از اینترنت می تونه شما رو از این وسوسه ها رها کنه و به شما اجازه
        می ده با خیال راحت به کارتون برسید.
      </p>,
      <p>(در ضمن، دومین زبان رایجی که در دنیا صحبت میشه اسپانیایی هست)</p>,
      <p>
        خود همین صفحه تست و آزمایشی در این زمینه هست. چی میشد اگه محتواي خاصی ما
        رو ملزم می کرد که از اینترنت قطع بشیم؟ چی میشد اگه خواننده ها به اون
        تمرکز فوق العاده اي که خوندن مشتاقانه یه رمان رو براي ساعت ها آن چنان
        رضایت بخش می کرد دسترسی داشتن؟ چی میشد اگه سازنده ها این قابلیت رو با
        دستگاه هاي مدرن همراه می کردن؟ موبایل ها و لپ تاپ هاي ما بسترهاي عالی
        هستن براي محتوایی که در اونا خلاقیت به کار برده بشه؛ اگه فقط می تونستیم
        قدرت توجه خودمون رو تحت کنترل در بیاریم.
      </p>,
      <p>
        محتوایی که فقط به صورت آفلاین در دسترس باشه سازنده ها رو هم وادار می کنه
        تا متفاوت فکر کنن. به همین صفحه نگاه کنید: حتی یک لینک هم در این صفحه
        نیست که حواس خواننده ها رو پرت کنه. تا حالا چند تا مقاله خوب رو نصفه
        کاره رها کردید چون رفتید دنبال یه لینک پر زرق و برق؟ وقتی شما آفلاین
        هستید، اینجا تنها جایی هست که می تونید باشید.
      </p>,
      <p>
        از همین الان می تونم شکایت ها رو بشنوم: " ولی من مجبورم براي کارم آنلاین
        باشم" من اهمیتی نمیدم. زمانش رو فراهم کنید . شرط می بندم اون چیزي که شما
        رو ارزشمند میکنه توانایی شما در جستجوي مطالب در گوگل نیست، بلکه توانایی
        شما در سنتز و ترکیب اطلاعات هست. تحقیقات خودتون رو آنلاین، و به صورت
        آفلاین کارتون رو انجام بدید و خلق کنید.
      </p>,
      <p>
        حالا هم برگردید به همون برنامه همیشگی و معمولی که در اینترنت دارید. فقط
        یادتون باشه هر ازگاهی به خوتون این لطف رو بکنید و از اینترنت قطع بشید.
      </p>,
      <Signature />,
      <p>
