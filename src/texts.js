...
export const languages = {
	...
	ru: {
		...
		onlineElements: () => [
			<h1>
				Чтобы просмотреть эту страницу, вам нужно выключить интернет.
			</h1>,
			<br />,
			<h2>
				{ MOBILE ?
					'Пожалуйста выключите интернет, чтобы продолжить. (авиарежима)'
					: 'Пожалуйста выключите интернет, чтобы продолжить.'
				}
			</h2>
		],
		...
		bodyParagraphs: () => [
			...
			<p>
				Вы хотите стать более производительным? Тогда просто выключите интернет. Ведь постоянный доступ к интернету - это постоянные перерывы, как внешние, так и внутренние.
			</p>,

			<p>
				Существует множество внешних перерывов, и мы их часто испытываем: то у вас новое сообщение в Gmail, то в Slack, то в Twitter, то в Facebook, то в Instagram, то в Snapchat, то в LinkedIn. Надеюсь, вы отчётливо понимаете, что каждый друг, член семьи, сотрудник или спаммер имеют доступ к вашему ценному вниманию.
			</p>,

			<p>
				Но всё же более пагубные перерывы в работе - внутренние. Конечно же вы можете выключить звук уведомлений в Twitter или выйти из Slack. Но каким образом можно выключить свой мозг и не реагировать на свои же мысли?
			</p>,
